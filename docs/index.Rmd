...
```{r echo = FALSE}
kable(table_info, col.names = c("state_name", "county_most_fires", "common_fire_size", "common_causes"))
```
### Table 2 - U.S. Fire Perimeters Summary

```{r echo = FALSE}
kable(table_info_2, col.names = c("fire_year", "max_total_acres", "common_causes"))
```
