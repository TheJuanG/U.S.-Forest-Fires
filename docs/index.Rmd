...
```{r echo = FALSE}
kable('html',table_info, col.names = c("state name", "county most fires", "common fire size", "common causes"))
```
### Table 2 - U.S. Fire Perimeters Summary

```{r echo = FALSE}
kable('html', table_info_2, col.names = c("fire year", "max total acres", "common_causes"))
```
